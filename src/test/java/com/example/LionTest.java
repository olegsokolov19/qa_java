...
public class LionTest {
    ...
    @Test
    public void shouldReturnOneKittens() throws Exception {
        lion = new Lion(sex);
        int expected = 1;
    ...
    @Test
    public void shouldHaveManeTrue() throws Exception {
        lion = new Lion(sex);
    ...
    public void shouldThrowExceptionWithIncorrectMane() {
        String actual = Assert.assertThrows(Exception.class, () -> new Lion("Другое")).getMessage();
